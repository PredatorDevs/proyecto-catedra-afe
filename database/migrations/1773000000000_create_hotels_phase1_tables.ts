...
export default class extends BaseSchema {
  ...
  async down() {
    await this.schema.raw('DROP TABLE IF EXISTS `additional_charge_catalog`;')
    await this.schema.raw('DROP TABLE IF EXISTS `room_prices`;')
    await this.schema.raw('DROP TABLE IF EXISTS `seasons`;')
    await this.schema.raw('DROP TABLE IF EXISTS `room_images`;')
    await this.schema.raw('DROP TABLE IF EXISTS `rooms`;')
    await this.schema.raw('DROP TABLE IF EXISTS `room_types`;')
    await this.schema.raw('DROP TABLE IF EXISTS `customers`;')
  }
}
